...
void comer () {  
    ...
    filosofo.setText("Comiendo su maruchitan");
    filosofo.setBackground(Color.GREEN);

    res=Integer.parseInt(resultado.getText());
    res+=1;
    resultado.setText(String.valueOf(res));
    proceso= "Filosofo= "+(id+1)+ " Comiendo usa sus tenedores\n";
    ...
    filosofo.setText("Filosofando");   
    filosofo.setBackground(Color.DARK_GRAY);
    proceso="Fil.= "+(id+1)+ " Deja de comer y filosofa, desocupa sus tenedores\n";  
    textArea.append(proceso);
}  
void pensar(){  
    derecho.setText("Libre");
